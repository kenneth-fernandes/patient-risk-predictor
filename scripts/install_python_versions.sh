...
if command -v pyenv &> /dev/null; then
    ...
    echo "   Download and install Python 3.9, 3.10, 3.11"
    echo ""
    echo -e "${YELLOW}3. Use conda/miniconda:${NC}"
    echo "   conda create -n py39 python=3.9"

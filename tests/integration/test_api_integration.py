...
class TestAPIIntegration:
    ...
    def test_predict_endpoint_integration_with_mock_model(
        self, integration_client, sample_patient_data
    ):
...
class TestMLUtilsIntegration:
    ...
    def test_get_latest_model_path_integration(self, mock_mlflow):
        ...
        mock_runs = pd.DataFrame({"run_id": ["latest_run"], "start_time": ["2024-01-01"]})
